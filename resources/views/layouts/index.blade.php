...
<body>
            ...
            @guest
                ...
                <nav class="hidden md:flex items-center gap-6">
                    <a href="{{ route('register') }}"
                        class="font-normal text-base bg-blue-700 px-6 py-2 rounded-full text-white">Register</a>
                </nav>
    ...
    <div id="popup-menu"
        ...
        <div class="p-4 flex flex-col items-center">
            <a href="{{ route('register') }}"
                class="block font-normal text-base bg-blue-700 px-6 py-2 rounded-full text-white text-center">Register</a>
        </div>
    </div>
